...
export default class Modal extends Component {
    ...
    render() {
        const { context, children, className, hidden, overlay, viewportCenter, style, tall, wide } = this.props;
...
Modal.Content = ({ children, padding }) => (
    <div className="nice-modal-body" style={ padding !== null ? { padding: `${ padding }px` } : null }>
        { children }
    </div>
);
