...
export default class Tabs extends Component {
    ...
    constructor(props, context) {
        ...
        this.state = {
            activeTabIndex: activeTabIndex || defaultActiveTabIndex
        };
    ...
    renderChildrenWithTabsApiAsProps() {
        return React.Children.map(this.props.children, (child, index) =>
            React.cloneElement(child, {
                ...
                tabIndex: index,
                isActive: index === (this.props.activeTabIndex || this.state.activeTabIndex)
            })
        );
    }
    ...
    renderActiveTabContent() {
        ...
        const activeTabIndex = (this.props.activeTabIndex || this.state.activeTabIndex);
