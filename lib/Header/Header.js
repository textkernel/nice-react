...
class Header extends Component {
    ...
    renderMenuToggle() {
        ...
        const toggleClass = ['nice-header-toggle'];

        if (collapsed) {
            toggleClass.push('collapsed');
        }

        return (<button type="button" className={ toggleClass.join(' ') }>
    ...
    render() {
        ...
        const headerClass = ['nice-header'];
        if (fixed) {
            headerClass.push('fixed');
        }
        const containerClass = ['nice-header-container'];
        if (fluid) {
